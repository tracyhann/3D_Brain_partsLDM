...
CONFIG="${CONFIG:-${CONFIG_PATH:-configs/whole_brain_aux_taux_spacing1p5_ADDITION.json}}"
TRAIN_SCRIPT="${TRAIN_SCRIPT:-scripts/train_3d_brain_ldm_aux_taux_addition_ddp.py}"
...
OUT_PREFIX="${OUT_PREFIX:-${CFG_PREFIX:-whole_brain_aux_taux_add_UNET}}"
