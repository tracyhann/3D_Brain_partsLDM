...
def build_expert_composite_branch(
    *,
    ...
    """
    Build expert composite and latent replacement ingredients at a shared t_aux.
        ...
        torch.save(
            {
                ...
                "compose_mode": "image_space_direct_parts",
...
def main():
    ...
    ap = argparse.ArgumentParser(
        description="Train whole-brain 3D LDM with Aux-tAux expert guidance.",
        parents=[pre_ap],
    )
