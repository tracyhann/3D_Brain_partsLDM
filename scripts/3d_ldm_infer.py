...
def main():
    ...
    ap.add_argument("--cond", default="", help="vol_norm,sex,age_norm in [0,1], e.g. 0.4,1,0.35")
    ...
    for i in range(args.num):
        ...
        with torch.no_grad():
            for t in sched.timesteps:
                ...
                z = step_prev_sample(step_out)

                if not torch.isfinite(z).all():
                    print(f"[warn] non-finite z at t={int(t)}; clamping")
        ...
        save_nii(x, outdir / f"{stem}.nii.gz")
