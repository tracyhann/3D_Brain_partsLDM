...
### Generate left, right, and mirrored right hemispheres
<pre>
  python data_prep/prep_data.py \
  --part right_hemi,right_hemi_mirror,left_hemi,hemi \
  --postfix 0120
</pre>
...
### Part fusion LDM
<pre>
python scripts/train_3d_brain_ldm_from_parts.py \
  --csv data/whole_brain+3parts+masks_0120.csv \
  --spacing 2,2,2 \
  --size 96,128,96 \
  --n_samples ALL \
  --torch_autocast True \
  ...
  --ldm_num_head_channels 0,64,64 \
  --ldm_sample_every 10 \
  --out_prefix whole_brain_from_parts_uncond_CLAMP_1e-4_450_AUTOCAST
</pre>

## 02/03/26
### Part fusion LDM (projected part latents as context)
<pre>
python scripts/train_3d_brain_ldm_from_proj_parts.py \
  --csv data/whole_brain+3parts+masks_0120.csv \
  --spacing 2,2,2 \
  --size 96,128,96 \
  --n_samples ALL \
...
## 02/04/26
### Part fusion LDM (projected coarse latents as cross attention)
<pre>
  python scripts/train_3d_brain_ldm_from_proj_coarse.py \
  --csv data/whole_brain+3parts+masks_0120.csv \
  --spacing 2,2,2 \
  --size 96,128,96 \
  --n_samples ALL \
  ...
  --ldm_num_head_channels 0,64,64 \
  --ldm_sample_every 10 \
  --out_prefix whole_brain_from_proj_coarse_uncond_1e-4_450_AUTOCAST
</pre>
