...
try:
    ...
    # Optional dependency: training/inference does not require these plotting helpers.
    def plot_latent(*args, **kwargs):
        return None

    def visualize_one_slice_in_3d_image(*args, **kwargs):
        return None

    def visualize_one_slice_in_3d_image_greyscale(*args, **kwargs):
        return None
...
class DiffusionInferer(Inferer):
    ...
    def sample(
        ...
        for t in progress_bar:
            ...
            if plot_img and t == 0:
                plot_latent(image.cpu().detach().numpy(), title=f"Sampling step {t}")
